...
exports.components={"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 883).then(__webpack_require__.bind(__webpack_require__, 429)),"component---src-pages-about-js":()=>__webpack_require__.e(/* import() | component---src-pages-about-js */ 682).then(__webpack_require__.bind(__webpack_require__, 5465)),"component---src-pages-authors-js":()=>__webpack_require__.e(/* import() | component---src-pages-authors-js */ 586).then(__webpack_require__.bind(__webpack_require__, 7575)),"component---src-pages-blog-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-blog-index-js */ 524).then(__webpack_require__.bind(__webpack_require__, 1025)),"component---src-pages-blog-mdx-frontmatter-slug-js-content-file-path-blog-first-post-index-mdx":()=>Promise.all(/* import() | component---src-pages-blog-mdx-frontmatter-slug-js-content-file-path-blog-first-post-index-mdx */[__webpack_require__.e(173), __webpack_require__.e(108)]).then(__webpack_require__.bind(__webpack_require__, 2067)),"component---src-pages-blog-mdx-frontmatter-slug-js-content-file-path-blog-second-post-index-mdx":()=>Promise.all(/* import() | component---src-pages-blog-mdx-frontmatter-slug-js-content-file-path-blog-second-post-index-mdx */[__webpack_require__.e(173), __webpack_require__.e(190)]).then(__webpack_require__.bind(__webpack_require__, 6192)),"component---src-pages-categories-js":()=>__webpack_require__.e(/* import() | component---src-pages-categories-js */ 823).then(__webpack_require__.bind(__webpack_require__, 740)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 678).then(__webpack_require__.bind(__webpack_require__, 6558))};
...
const trimmedPathname=stripPrefix(pathname,decodeURIComponent("/github.atlansec.io"))// Remove any hashfragment
...
if(this.staticQueryDb[staticQueryHash]){const jsonPayload=this.staticQueryDb[staticQueryHash];return{staticQueryHash,jsonPayload};}return this.memoizedGet(`${"/github.atlansec.io"}/page-data/sq/d/${staticQueryHash}.json`).then(req=>{const jsonPayload=JSON.parse(req.responseText);return{staticQueryHash,jsonPayload};}).catch(()=>{throw new Error(`We couldn't load "${"/github.atlansec.io"}/page-data/sq/d/${staticQueryHash}.json"`);});})).then(staticQueryResults=>{const staticQueryResultsMap={};staticQueryResults.forEach(({staticQueryHash,jsonPayload})=>{staticQueryResultsMap[staticQueryHash]=jsonPayload;this.staticQueryDb[staticQueryHash]=jsonPayload;});return staticQueryResultsMap;});return Promise.all([componentChunkPromises,staticQueryBatchPromise]).then(([pageResources,staticQueryResults])=>{let payload;if(pageResources){payload={...pageResources,staticQueryResults};finalResult.payload=payload;emitter.emit(`onPostLoadPageResources`,{page:payload,pageResources:payload});}this.pageDb.set(pagePath,finalResult);if(finalResult.error){return{error:finalResult.error,status:finalResult.status};}return payload;})// when static-query fail to load we throw a better error
...
const React=__webpack_require__(2006);const{grabMatchParams}=__webpack_require__(9755);const{StaticQueryContext}=__webpack_require__(7076);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9706);const{ServerLocation,Router}=__webpack_require__(7896);const{renderToString}=__webpack_require__(5227);const{parse}=__webpack_require__(698);const styleToOjbect=__webpack_require__(7848);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(6464),e=__webpack_require__(2006),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
"use strict";
module.exports = require("/home/w4z0s/Programacion/Atlansec/Blog/atlansec.github.io/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/home/w4z0s/Programacion/Atlansec/Blog/atlansec.github.io/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/home/w4z0s/Programacion/Atlansec/Blog/atlansec.github.io/node_modules/react/index.js");
...
/******/ 			return "" + ({"108":"component---src-pages-blog-mdx-frontmatter-slug-js-content-file-path-blog-first-post-index-mdx","190":"component---src-pages-blog-mdx-frontmatter-slug-js-content-file-path-blog-second-post-index-mdx","524":"component---src-pages-blog-index-js","586":"component---src-pages-authors-js","678":"component---src-pages-index-js","682":"component---src-pages-about-js","823":"component---src-pages-categories-js","883":"component---src-pages-404-js"}[chunkId] || chunkId) + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
const React=__webpack_require__(2006);const path=__webpack_require__(1423);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(5227);const{ServerLocation,Router,isRedirect}=__webpack_require__(7896);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(7076);const fs=__webpack_require__(6126);const{WritableAsPromise}=__webpack_require__(5897);const{RouteAnnouncerProps}=__webpack_require__(236);const{apiRunner,apiRunnerAsync}=__webpack_require__(4067);const asyncRequires=__webpack_require__(5418);const{version:gatsbyVersion}=__webpack_require__(1741);const{grabMatchParams}=__webpack_require__(9755);const{headHandlerForSSR}=__webpack_require__(923);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(8995);const{ServerSliceRenderer}=__webpack_require__(7529);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
...
await apiRunnerAsync(`replaceRenderer`,{bodyComponent,replaceBodyHTMLString,setHeadComponents,setHtmlAttributes,setBodyAttributes,setPreBodyComponents,setPostBodyComponents,setBodyProps,pathname:pagePath,pathPrefix:"/github.atlansec.io"});// If no one stepped up, we'll handle it.
...
if(!isRedirect(e))throw e;}}apiRunner(`onRenderBody`,{setHeadComponents,setHtmlAttributes,setBodyAttributes,setPreBodyComponents,setPostBodyComponents,setBodyProps,pathname:pagePath,loadPageDataSync,bodyHtml,scripts,styles,pathPrefix:"/github.atlansec.io"});// we want to run Head after onRenderBody, so Html and Body attributes
